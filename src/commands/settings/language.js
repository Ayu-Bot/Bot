...
module.exports = class extends Command {
    constructor(client) {
        super(client, {
            ...
            options: [{
             ...
             required:true,
             choices: [{name: "Portugues Brasileiro", value: "pt-br"}, {name: "Türkçe", value: "tr-tr"}, {name: "English (US)", value: "en-us"}]
            }]
        })
    }
    run = async (interaction) => {
        ...
        user.save()
        const lang = await this.client.lang({lang: user.lang, cmd: 'language'})
